...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     */
    protected TextView createDefaultTabView(Context context, DisplayMetrics metrics) {
        TextView textView = new TextView(context);
        textView.setGravity(Gravity.CENTER);
        textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, TAB_VIEW_TEXT_SIZE_SP);
        textView.setTypeface(Typeface.DEFAULT_BOLD);

        textView.setWidth((int) ((metrics.widthPixels - getResources().getDimension(R.dimen.activity_horizontal_margin)*2)/4));
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (tabView == null) {
                tabView = createDefaultTabView(getContext(), metrics);
            }
